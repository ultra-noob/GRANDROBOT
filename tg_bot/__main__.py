...
PM_START_TEXT = """
**Hello {}, My Name is {}!** 
I am an **SUPERB**  group management bot, Created by Nikhil.
...
TECHNO_IMG = "https://telegra.ph/file/2d4bcdd718874d25773f1.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/Nikhil_222")],
                                                                                   [InlineKeyboardButton(text="ADD RAVAN TO YOUR GROUP",
                                                                       url="t.me/{}?startgroup=true".format(bot.username)),
                                                                                   InlineKeyboardButton(text="Source Code",
                                                                       url="https://github.com/ultra-noob/GRANDROBOT")
                                                                                 ]]))

    else:
        update.effective_message.reply_text("Zinda Hu 👿👿")
